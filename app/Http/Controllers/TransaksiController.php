...
class TransaksiController extends Controller
{
    ...
    public function index()
    {
        ...
        ->select('table_transaksi.id','table_anggota.nama_anggota','table_buku.id_buku', 'table_buku.judul_buku', 'table_buku.deskripsi', 'table_kategori.deskripsi as kategori', 'table_transaksi.tgl_pinjam','table_transaksi.tgl_kembali')
        ->get();
        ...
        if(Anggota::where('id_anggota', $request->id_anggota)->count() > 0){
            if(Buku::where('id_buku', $request->id_buku)->count() > 0){
                ...
                if($request->type_transaksi == 'pinjam'){
                    ...
                    $transaksi->save();
                    return redirect()->route('transaksi.index')->with('pesan', 'Data Berhasil di Simpan');
                }else{
                ...
                return json_encode('Maaf, Buku Tidak Di Temukan!');
            }
        }else{
            return json_encode('Maaf, Anggota Tidak Di Temukan!');
        }
    }
    ...
    public function show($id)
    {
        ...
        ->join('table_kategori', 'table_kategori.kategori', '=', 'table_buku.kategori')
        ->select('table_transaksi.id','table_transaksi.id_anggota', 'table_anggota.nama_anggota', 'table_buku.id_buku', 'table_buku.judul_buku','table_buku.deskripsi', 'table_kategori.deskripsi as kategori','table_transaksi.tgl_pinjam', 'table_transaksi.tgl_kembali')
    ...
    public function edit($id)
    {
        ...
        return view('admin.transaksi.kembali', compact('pinjaman'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('transaksi.index')->with('pesan','Data Berhasil di Ganti!');
    }
    ...
    public function destroy($id)
    {
        $transaksi = Transaksi::find($id); 
        $transaksi->delete();
        return redirect()->route('transaksi.index')->with('pesan', 'Data berhasil di Hapus!');
    }
}
